...
SETTINGS_DICT = {
    ...
    'ROOT_URLCONF': '{{cookiecutter.projectname}}.tests.urls',
    'DATABASES': {
        'default': {
    ...
    'TEMPLATES': [
        {
            ...
            'APP_DIRS': True,
            'DIRS': [
                os.path.join(APP_DIR, '{{cookiecutter.projectname}}', 'templates'),
                os.path.join(APP_DIR, '{{cookiecutter.projectname}}', 'tests', 'templates'),
            ],
            'OPTIONS': {
                'context_processors': [
